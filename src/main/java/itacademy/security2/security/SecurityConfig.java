package itacademy.security2.security;

import itacademy.security2.filter.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests().requestMatchers(POST, "/api/user/status/**").hasAnyAuthority("ROLE_SUPER_ADMIN");
